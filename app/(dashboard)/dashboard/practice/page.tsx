    ...
    <div className="space-y-6 max-w-4xl mx-auto font-body">
      ...
      <div className="bg-[#12121E] border border-gray-800/80 rounded-2xl p-8 text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <h2 className="font-display font-bold text-white text-lg">AI Simulator Sandbox Mode</h2>
          <p className="text-xs text-gray-400 max-w-sm mx-auto leading-relaxed">
            Enter the interactive audio and chat simulation to practice real estate closing scripts with Nigerian buyer personas.
          </p>
        </div>
        <Link
          href="/dashboard"
